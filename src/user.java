...
public class user extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kasir", "admin" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(iduser, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
...
dispose();        // TODO add your handling code here:
 ...
 try {
            String sql = "INSERT INTO tblogin VALUES ('"+ iduser.getText() +"','"+ nama.getText() +"','"+ user.getText() +"','"+ pass.getText() +"','"+ jabatan.getSelectedItem() +"')";
 ...
 try {
            String sql = "DELETE FROM tblogin where idlogin= '"+iduser.getText()+"'";
            java.sql.Connection conn=(Connection)KoneksiDatabase.getKoneksi();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
